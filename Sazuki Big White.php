...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Sazuki<span> Big White </span></h3>
			<!--/w3_short-->
	     ...
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="pageimages/e1.jpg">
							<div class="thumb-image"> <img src="pageimages/e1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="pageimages/e2.jpg">
							<div class="thumb-image"> <img src="pageimages/e2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="pageimages/e3.jpg">
							<div class="thumb-image"> <img src="pageimages/e3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
					  ...
					  <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
										...
										<img src="images/w2.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="SahaZor Black.php" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
									...
									<div class="item-info-product ">
										<h4><a href="SahaZor Black.php">SahaZor Black</a></h4>
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1">
																	<input type="hidden" name="business" value=" ">
																	<input type="hidden" name="item_name" value="SahaZor Black">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										...
										<img src="images/w4.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="Round Sp.php" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
											<span class="product-new-top">New</span>
									...
									<div class="item-info-product ">
										<h4><a href="Round Sp.php">Round Sp</a></h4>
										<div class="info-product-price">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1">
																	<input type="hidden" name="business" value=" ">
																	<input type="hidden" name="item_name" value="Round Sp">
																	<input type="hidden" name="amount" value="30.99">
																	<input type="hidden" name="discount_amount" value="1.00">
																	<input type="hidden" name="currency_code" value="USD">
																	<input type="hidden" name="return" value=" ">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										...
										<img src="images/m3.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="Handi Fram.php" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
											<span class="product-new-top">New</span>
									...
									<div class="item-info-product ">
										<h4><a href="Handi Fram.php">Handi Fram  </a></h4>
										<div class="info-product-price">
											<span class="item_price">$120.99</span>
											<del>$199.71</del>
										</div>
					   ...
					   <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="HL Black.php">HL Black</a></h4>
										<div class="info-product-price">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1">
																	<input type="hidden" name="business" value=" ">
																	<input type="hidden" name="item_name" value="HL Black">
																	<input type="hidden" name="amount" value="30.99">
																	<input type="hidden" name="discount_amount" value="1.00">
																	<input type="hidden" name="currency_code" value="USD">
																	<input type="hidden" name="return" value=" ">
