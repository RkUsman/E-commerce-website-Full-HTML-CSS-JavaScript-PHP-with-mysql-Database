	     ...
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="pageimages/i1.jpg">
							<div class="thumb-image"> <img src="pageimages/i1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="pageimages/i2.jpg">
							<div class="thumb-image"> <img src="pageimages/i2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="pageimages/i3.jpg">
							<div class="thumb-image"> <img src="pageimages/i3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
