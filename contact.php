...
<html>
<head>
<title>M.NAZIR KMANI BUSH CENTER |  Contact:: RkUsman</title>
<!--/tags -->
		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>UmarPark St, Near Mcc Flat,BankStop, Lahore Pakistan.</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p>+92 311 983 8703<span>+92 308 431 0400</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:mu380000@gmail.com">info@RkUsman.com</a><span><a href="mailto:ia679621@gmail.com">info@M.Nazir.com</a></span></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>+92 311 983 8703</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:mu380000@gmail.com">info@RkUsman.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Location</p><span>UmarPark St, Near Mcc Flat,BankStop, Lahore Pakistan.</span>
								</div>
								<div class="clearfix"> </div>
							</div>
			...
			<div class="w3layouts_mail_grid">
				<div class="col-md-3 w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>FREE SHIPPING</h3>
						<p>Shipping in all over Pakistan is avilable.</p>
					</div>
				</div>
				<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="mens.php">SPECIAL BUSH</a></li>
						<li><a href="womens.php">AMM BUSH</a></li>
