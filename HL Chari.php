						...
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">AMM BUSH <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="Frame Red.php">Frame Red</a></li>
											<li><a href="Handi Fram Amm.php">Handi Fram Amm</a></li>
											<li><a href="Frame White.php">Frame White</a></li>
											<li><a href="http://itmasti.000webhostapp.com">itmasti</a></li>
										</ul>
									</div>
	     ...
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="pageimages/f1.jpg">
							<div class="thumb-image"> <img src="pageimages/f1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="pageimages/f2.jpg">
							<div class="thumb-image"> <img src="pageimages/f2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="pageimages/f3.jpg">
							<div class="thumb-image"> <img src="pageimages/f3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
